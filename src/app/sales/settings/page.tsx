      ...
      <div className="mx-auto max-w-3xl p-8">
        ...
        <div className="mb-5 rounded-2xl bg-white p-6 shadow-md">
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F5C400] text-white">
              <User size={19} />
            </div>
          ...
          <div className="flex items-center justify-between border-b border-gray-200 py-4">
            ...
            <button className="rounded-lg px-4 py-2 text-sm font-medium text-[#F5C400] hover:bg-gray-100">
              Edit
            </button>
          </div>
        ...
        <div className="mb-5 rounded-2xl bg-white p-6 shadow-md">
          ...
          <div className="flex items-center justify-between">
            ...
            <input
              type="checkbox"
              defaultChecked
              className="h-5 w-5 accent-[#F5C400]"
            />
          </div>
        </div>
        ...
        <div className="mb-5 rounded-2xl bg-white p-6 shadow-md">
          ...
          <button className="rounded-xl bg-[#F5C400] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#271b46]">
            Ubah Password
          </button>
        </div>
